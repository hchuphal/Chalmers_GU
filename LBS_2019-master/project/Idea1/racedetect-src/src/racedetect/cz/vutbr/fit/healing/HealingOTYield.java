...
/**
 * Healing method that uses <i>yield</i> called on the threads trying to access
 ...
 *
 */
class HealingOTYield extends Healing {
	...
	protected void beforeNormalAccess(RDVariable rdv, RDThread rdt) {
		/*
		 * if anyone is in the healing section - yield
		 */
