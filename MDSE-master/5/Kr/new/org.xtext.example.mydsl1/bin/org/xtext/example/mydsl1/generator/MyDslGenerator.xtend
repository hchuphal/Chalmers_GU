...
fsa.generateFile('LegoBrick.gv',
            '''  
            	...
            	«FOR m : resource.allContents.filter(ComplexBrick).toIterable»
                    ...
                    «IF(m.getSize.get(0).dimensions.brickHeight >= 2)»
               		...
               		«IF(m.getSize.get(0).dimensions.brickWidth > 2 && 
               			m.getSize.get(0).dimensions.brickWidth < 6)»
               			 «IF(m.hasPosition.get(0).coordinates.getName == 'Left')»
					//NEW BRICK LEFT
            		...
            		script.addObject(cube, new CoordinateSystem(pos, 0, 0, 0));
					«ENDIF»  
					«IF(m.hasPosition.get(0).coordinates.getName == 'Right')»
					//NEW BRICK RIGHT
					...
					«ENDIF» 
               		...
               		«IF(m.getSize.get(0).dimensions.brickWidth == 6)»
               		//NEW BRICK LEFT
                     ...
                     «ENDIF» 
                      ...
                      «IF(m.getSize.get(1).dimensions.brickHeight >= 2)»
                      //NEW BRICK TOP
                      ...
                      script.addObject(cube, new CoordinateSystem(pos, 0, 0, 0));
                      «IF(m.getSize.get(1).dimensions.brickWidth == 6)»
	             		//NEW BRICK LEFT
	             		
	             		//Cyllinders
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(3.5, 2, 6);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(3.5, 2, 8.8);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		
	             		
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(0.75, 2, 6);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(0.75, 2, 8.8);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		...
	             		//Cyllinders
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(3.5, 2, -1.75);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(3.5, 2, -4.55);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(0.75, 2, -1.75);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		
	             		tube = new Cylinder(0.75, 1, 1, 1);
	             		pos = new Vec3(0.75, 2, -4.55);
	             		script.addObject(tube, new CoordinateSystem(pos, 0, 0, 0));
	             		...
	             		«IF(m.getSize.get(1).dimensions.brickWidth > 2 && 
	             		    m.getSize.get(1).dimensions.brickWidth < 6)»
	             		   «IF(m.hasPosition.get(1).coordinates.getName == 'Left')»
	             		 //NEW BRICK LEFT
 	             		...
 	             		script.addObject(cube, new CoordinateSystem(pos, 0, 0, 0));
	             		 «ENDIF» 
	             		 «IF(m.hasPosition.get(1).coordinates.getName == 'Right')»
	             		 //NEW BRICK RIGHT
