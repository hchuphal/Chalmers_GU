...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getComplexBrickAccess().getGroup_12(), "rule__ComplexBrick__Group_12__0");
			...
			builder.put(grammarAccess.getComplexBrickAccess().getHasPositionAssignment_10(), "rule__ComplexBrick__HasPositionAssignment_10");
			builder.put(grammarAccess.getComplexBrickAccess().getGetSizeAssignment_12_1(), "rule__ComplexBrick__GetSizeAssignment_12_1");
			builder.put(grammarAccess.getComplexBrickAccess().getHasPositionAssignment_12_3(), "rule__ComplexBrick__HasPositionAssignment_12_3");
