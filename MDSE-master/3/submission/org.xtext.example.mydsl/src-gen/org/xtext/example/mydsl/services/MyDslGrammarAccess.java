...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TransportStepElements extends AbstractParserRuleElementFinder {
		...
		//("," transition+=[ManufacturingSystemElement|EString])*)? 'set' 'responsible' responsible=[Responsible|EString] 'input'
		//'{' input+=InputCondition ("," input+=InputCondition)* '}' 'output' '{' output+=OutputDecision (","
		//output+=OutputDecision)* '}' '}'
		public Group getGroup() { return cGroup; }
