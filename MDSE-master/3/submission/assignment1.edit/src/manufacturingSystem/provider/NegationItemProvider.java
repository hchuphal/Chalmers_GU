...
/**
 * This is the item provider adapter for a {@link manufacturingSystem.Negation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NegationItemProvider extends InputConditionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Negation_contains_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Negation_contains_feature", "_UI_Negation_type"),
				 ManufacturingSystemPackage.Literals.NEGATION__CONTAINS,
				 true,
				 false,
				 true,
				 null,
