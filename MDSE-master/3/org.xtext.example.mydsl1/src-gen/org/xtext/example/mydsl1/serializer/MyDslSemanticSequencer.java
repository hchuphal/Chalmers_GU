...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=EString getSize+=[BrickElement|EString] hasPosition+=Position (getSize+=[BrickElement|ID] hasPosition+=Position)*)
	 */
	...
	protected void sequence_Position(ISerializationContext context, Position semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BrickModel2Package.Literals.POSITION__X) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrickModel2Package.Literals.POSITION__X));
			if (transientValues.isValueTransient(semanticObject, BrickModel2Package.Literals.POSITION__Y) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrickModel2Package.Literals.POSITION__Y));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPositionAccess().getXEIntParserRuleCall_1_0(), semanticObject.getX());
		feeder.accept(grammarAccess.getPositionAccess().getYEIntParserRuleCall_3_0(), semanticObject.getY());
		feeder.finish();
	}
